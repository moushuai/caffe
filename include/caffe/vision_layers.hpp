...
//this code is added by myself,maybe there will some errors exist.
template <typename Dtype>
class MyImageDataLayer : public Layer<Dtype>  {
 public:
  ...
  // virtual inline LayerParameter _LayerType type() const {
  //   return LayerParameter _LayerType_MY_IMAGE_DATA;
  // }
